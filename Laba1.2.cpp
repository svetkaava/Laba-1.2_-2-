...
static void RenderSceneCB() //функция отображения на экран
{
    ...
    glDrawArrays(GL_POINTS, 0, 1);//функция для отрисовки, порядковая
...
{
    Vector3f Vertices[1];//создание массива из одного экземпляра структуры Vector3f
    Vertices[0] = Vector3f(0.0f, 0.0f, 0.0f);  //задаем точку в середине экрана
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Создание точки");//заголовок окна
